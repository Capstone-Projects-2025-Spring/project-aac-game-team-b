...
export default function Home() {
  ...
  return (
    <div className="flex w-screen h-screen bg-sky-800 p-8">
      
      {/* Left Panel: AAC Tablet */}
       <div className="w-1/3 bg-blue-500 p-4 flex flex-col justify-center items-center rounded-l-2xl shadow-2xl border-4 border-indigo-600">
      ...
      <div
        className="w-2/3 relative bg-cover bg-center flex justify-center items-center rounded-r-2xl shadow-2xl border-4 border-indigo-600"
        style={{
